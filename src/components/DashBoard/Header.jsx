...
const Header = () => {
  ...
  return (
    <div className="fixed w-full lg:hidden border-b">
      ...
      {menu && (
        <>
          <div className="bg-white h-fit px-4 pb-4">
            <select className="w-full p-2 rounded-md border border-[#D5D7DA] focus:outline-none">
          ...
          <div className="w-full h-screen bg-[#6C6C6C4D]"></div>
        </>
      )}
    </div>
  );
